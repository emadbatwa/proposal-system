...
<div class="flex-center position-ref full-height">
    @if (Route::has('login'))
        <div class="top-right links">
            @auth
                <a href="{{ url('/proposal') }}">مقترحاتي</a>
            @else
    ...
    <div class="content">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                @guest
                    <p>
                        <a href="{{ route('register') }}" class="btn btn-primary my-2">تسجيل جديد</a>
                        <a href="{{ route('login') }}" class="btn btn-secondary my-2">تسجيل الدخول</a>
                    </p>
                @endguest
                @auth
